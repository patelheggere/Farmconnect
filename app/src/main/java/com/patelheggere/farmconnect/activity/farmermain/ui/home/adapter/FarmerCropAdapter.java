package com.patelheggere.farmconnect.activity.farmermain.ui.home.adapter;
...
public class FarmerCropAdapter extends RecyclerView.Adapter<FarmerCropAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.farmer_crop_item, parent, false);
