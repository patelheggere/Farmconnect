package com.patelheggere.farmconnect.activity.merchantmain.ui.dashboard.adapter;
...
public class FarmerCropAdapter extends RecyclerView.Adapter<FarmerCropAdapter.MyViewHolder> {
    ...
    public FarmerCropAdapter(Context context, List<FarmerCropModel> dataList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.farmer_history_crop_item, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        try {
            ...
            {
                holder.bidSuccess.setText("No bids");
            }
            if(dataModel.getCropImageIcon()!=null)
            {
