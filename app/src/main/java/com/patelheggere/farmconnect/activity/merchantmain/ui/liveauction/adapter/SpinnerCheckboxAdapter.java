...
public class SpinnerCheckboxAdapter extends ArrayAdapter<FilterCheckBoxModel> {
    ...
    public SpinnerCheckboxAdapter(Context context, int resource, List<FilterCheckBoxModel> objects, CheckedValue checkedValue) {
        ...
        holder.mCheckBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (!isFromView) {
                    ...
                    {
                        checkedValue.getPosition(listState, position);
                    }
                }
            }
        });
