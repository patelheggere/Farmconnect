package com.patelheggere.farmconnect.activity.merchantmain;
...
public class MerchantMainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(url!=null)
        {
            Glide.with(MerchantMainActivity.this).load(url).into(mImageViewAvatar);
        ...
        navigation.setSelectedItemId(R.id.navigation_live_auction);
                ...
                .addOnCompleteListener(new OnCompleteListener<InstanceIdResult>() {
                    ...
                    public void onComplete(@NonNull Task<InstanceIdResult> task) {
                        ...
                        if(SharedPrefsHelper.getInstance().get("TOKEN")==null || !token.equalsIgnoreCase(SharedPrefsHelper.getInstance().get("TOKEN").toString())) {
                            ...
                            Call<APIResponseModel> apiResponseModelCall = apiInterface.updateMerchantFcm(phone, token);
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            switch (item.getItemId()) {
               ...
               /* case R.id.navigation_events:
                ...
                case R.id.navigation_live_auction:
                    if (curFrag != null) {
                        fragmentTransaction.detach(curFrag);
                    }
                    fragment = fragmentManager.findFragmentByTag("JOBS");
                    if (fragment == null) {
                        fragment = new LiveAuctionFragment();
    ...
    private void showAlert() {
        final AlertDialog.Builder builder = new AlertDialog.Builder(MerchantMainActivity.this);
    ...
    private void showConfirmationDialog(final String language) {
        android.app.AlertDialog.Builder alertBuilder = new android.app.AlertDialog.Builder(MerchantMainActivity.this);
        ...
        alertBuilder.setPositiveButton(getString(R.string.yes), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if(!language.equalsIgnoreCase(lan)) {
                    ...
                    setLocale(MerchantMainActivity.this);
                    finish();
    ...
    private void selectImage() {
        ...
        builder.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int item) {
                boolean gallery = AppUtils.checkPermission(MerchantMainActivity.this);
                boolean camera = AppUtils.checkPermissionCamera(MerchantMainActivity.this);
    ...
    private void onSelectFromGalleryResult(Intent data, String mediaType) {
        ...
        if (path != null) {
            if (path.toString().contains("com.google.android.apps.photos")) {
                ...
                String filePath = FilePath.getPathFromInputStreamUri(MerchantMainActivity.this, path);
                ...
                String filePath = getRealPathFromUri(MerchantMainActivity.this, path);
                if (filePath != null) {
                    original = new File(filePath);
    ...
    private void uploadImage(Uri filePath) {
        ...
        if(filePath != null)
        {
            final ProgressDialog progressDialog = new ProgressDialog(MerchantMainActivity.this);
            ...
            ref.putFile(filePath)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(MerchantMainActivity.this, "Uploaded", Toast.LENGTH_SHORT).show();
                        }
                ...
                public void onFailure(@NonNull Exception e) {
                    progressDialog.dismiss();
                    Toast.makeText(MerchantMainActivity.this, "Failed "+e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            })
