...
public class FarmerCropNotificationAdapter extends RecyclerView.Adapter<FarmerCropNotificationAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        try {
            ...
            holder.mButtonReject.setVisibility(View.GONE);
            holder.mButtonAccept.setText(context.getString(R.string.continue_for_payment));
           // holder.mButtonAccept.wi
            if(dataModel.getUploadedTime()!=0)
            {
                ...
                String mess = "You are bid <b>"+dataModel.getCropName()+"</b> crop on <b>"+simple.format(date)+"</b>  and farmer accepted your bid <b>"+context.getString(R.string.Rs)+""+dataModel.getBiddingPrice()+"</b> Please tap on continue and get details of farmer";
