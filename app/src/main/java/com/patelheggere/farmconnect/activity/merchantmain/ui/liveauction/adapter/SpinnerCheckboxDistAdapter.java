...
public class SpinnerCheckboxDistAdapter extends ArrayAdapter<FilterCheckBoxModel> {
    private Context mContext;
    private ArrayList<FilterCheckBoxModel> listState;
    private SpinnerCheckboxDistAdapter myAdapter;
    private boolean isFromView = false;
    private CheckedValue checkedValue;

    public SpinnerCheckboxDistAdapter(Context context, int resource, List<FilterCheckBoxModel> objects, CheckedValue checkedValue) {
        ...
        holder.mCheckBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (!isFromView) {
                    ...
                    {
                        checkedValue.getDistPosition(listState, position);
                    }
                }
            }
        });
